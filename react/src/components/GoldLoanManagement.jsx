...
//         setGoldLoans(loansWithDueDates); // FIX: Use loansWithDueDates instead of response.data
//         calculateStats(loansWithDueDates); // FIX: Use loansWithDueDates instead of response.data
//       } else {
...
//         const amount = loan.totalLoanAmount || 0; // This looks correct from your data
//         console.log(`Loan ${loan._id}: totalLoanAmount = ${amount}`);
//         return sum + amount;
//       }, 0),
//       totalOutstanding: loans.reduce((sum, loan) => {
//         // FIX: Use currentLoanAmount instead of currentPrincipalPaise
...
//         case 'loanAmount':
//           // FIX: Use totalLoanAmount instead of principalPaise
...
//   // FIX: Simplified format function for actual amounts (not in paise)
