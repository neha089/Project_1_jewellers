  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      >
        <TrendingUp
          size={32}
          className="mx-auto text-emerald-600 mb-3 group-hover:scale-110 transition-transform"
        />
        <h4 className="font-semibold text-emerald-900 mb-2">Income</h4>
        <p className="text-sm text-emerald-700">
          Sales, interest, loan repayments
        </p>
      </button>
      ...
      >
        <TrendingDown
          size={32}
          className="mx-auto text-rose-600 mb-3 group-hover:scale-110 transition-transform"
        />
        ...
        {categories.map((category) => {
          ...
          return (
            ...
            >
              <Icon
                size={24}
                className={`text-${category.color}-600 mb-3 group-hover:scale-110 transition-transform`}
              />
              <h4 className={`font-semibold text-${category.color}-900 mb-1`}>
                {category.label}
              </h4>
            </button>
          );
