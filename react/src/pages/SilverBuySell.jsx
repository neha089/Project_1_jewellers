...
import { Plus, Search, Filter, TrendingUp, TrendingDown, Calendar, User, Weight, DollarSign, Eye, Edit, Trash2, Zap } from 'lucide-react';
...
const SilverBuySell = () => {
  ...
  // Mock data for silver transactions
  ...
  const silverTypes = ['800 Silver', '925 Sterling', '950 Silver', '999 Fine'];
  const silverRates = {
    '800 Silver': 75,
    '925 Sterling': 85,
    '950 Silver': 88,
  ...
  const handleInputChange = (e) => {
    ...
    setFormData(prev => ({
      ...prev,
      [name]: value,
      ...(name === 'silverType' && { rate: silverRates[value] })
    }));
  };
                  ...
                  <tr key={transaction.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        <div className="font-medium">{transaction.silverType}</div>
                        <div className="text-gray-500 flex items-center">
                          <Weight className="w-3 h-3 mr-1" />
                          {transaction.weight}g @ ₹{transaction.rate}/g
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">New Silver Transaction</h2>
                  <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-gray-700">₹{calculateTotal()}</span>
                    </div>
                  </div>
